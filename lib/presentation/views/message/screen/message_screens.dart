...
class _MessageScreensState extends State<MessageScreens> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<AllConversationModel> allConversations =
        provider.allConversationModel;
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (isGroup) {
                        ...
                        if (_currentUserId != null &&
                            conv.creatorId == _currentUserId) {
                          displayName =
                              conv.receiverTitle?.trim() ?? "Direct Message";
                        } else {
                          displayName =
                              conv.senderTitle?.trim() ?? "Direct Message";
                        }
                      }
                      ...
                      if (!isGroup) {
                        avatarUrl = conv
                            .otherUserAvatar; // Web এ এটাই ব্যবহার করা হয়েছে
                      }
