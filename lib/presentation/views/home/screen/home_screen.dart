...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  String? formattedDate(String? createdAt) {
    ...
    final parseDate = DateTime.parse(createdAt);
    final formatted = "${parseDate.day}-${parseDate.month}-${parseDate.year}";
    return formatted;
  }
  ...
  String? dueDateFormatted(String? dueDate) {
    ...
    final parseDate = DateTime.parse(dueDate);
    final dueFormatted = "${parseDate.day}";
    return dueFormatted;
  }
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: 6.w),
                                        Text(
                                          'Due in ${dueDateFormatted(upComingAssignmentsValues?.dueDate ?? 'N/A')} days',
                                          style: TextStyle(
